...
public class BankZcxxServices {
    ...
    public void downloadFile(String seach, HttpServletResponse rep, String aj) throws Exception{
        ...
        rep.setHeader("Content-Disposition","attachment;filename="+new String(("银行卡开户信息\""+aj+".xlsx").getBytes(), "ISO8859-1"));
    ...
    public XSSFWorkbook createExcel(List<BankZcxxEntity> listZcxx) throws Exception{
        XSSFWorkbook wb = new XSSFWorkbook();
        Sheet sheet = wb.createSheet("银行卡开户信息");
        String[] title={"序号","账户状态","交易卡号","交易账号","开户姓名","开户证件号","账户余额","可用余额","开户时间","开户行"};

                ...
                <div class="cantent_block ">
                    ...
                    <div class="sidebar_right pos_re">
                            ...
                            <div>
                                <form action="/SINOFAITH/pyramidSale/SeachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容,如果使用模糊查询请加%" name="seachCode" >${psSeachCode}</textarea>
                                    </div>
                       ...
                       <span class="fl_l width100 " style="padding-bottom: 10px;margin-top: 10px;">
                           ...
                           <button  type="button"  class="sideBar_r_button"  <c:if test="${aj!=null}">onclick="location.href='/SINOFAITH/pyramidSale/download'"</c:if>>数据导出</button>
                       </span>
                                    </div>
                                </div>
                            </div>

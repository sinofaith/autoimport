                                ...
                                <table class="table  table-hover table_style table_list1 " style="border-left: 1px solid #ccc; border-right: 1px solid #ccc!important;">
                                    ...
                                    <c:forEach items="${detailinfo}" var="item" varStatus="st">
                                        <tr class="${st.index%2==1 ? '':'odd' }">
                                            ...
                                            <td align="center"><div style="width:60px;white-space: nowrap;text-overflow:ellipsis; overflow:hidden;">${item.zjlx}</div></td>
                                       ...
                                       <span class="fl_l width100 " style="padding-bottom: 10px;margin-top: 10px;">
                                           <c:choose>
                                               <c:when test="${user.id==aj.userId}">
                                                   ...
                                                   <button  type="button"  class="sideBar_r_button" <c:if test="${aj!=null && detailinfo!=null && detailinfo.size()!=0}">onclick="location.href='/SINOFAITH/zfb/download'"</c:if>>数据导出</button>                               </c:when>
                                               <c:otherwise>
            ...
            <div class="modal-body">
                ...
                <div class="file-box">
                    ...
                    <div class="radio radio-info radio-inline">
                        ...
                        <label class="label_c" for="inlineRadio1"> csv </label>
                    </div>

                            ...
                            <div>
                                <form action="/SINOFAITH/wuliujjxx/SeachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容" name="seachCode" >${seachCode}</textarea>
                                    </div>
                                       ...
                                       <span class="fl_l width100 " style="padding-bottom: 10px;margin-top: 10px;">
                                           <c:choose>
                                               <c:when test="${user.id==aj.userId}">
                                                   ...
                                                   <button  type="button"  class="sideBar_r_button"  <c:if test="${aj!=null && detailinfo.size()!=0}">onclick="location.href='/SINOFAITH/wuliujjxx/download'"</c:if>>数据导出</button>                                               </c:when>
                                               <c:otherwise>

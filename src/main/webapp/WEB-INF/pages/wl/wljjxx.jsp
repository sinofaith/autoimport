                ...
                <div class="cantent_block ">
                            ...
                            <div >
                                ...
                                <table class="table  table-hover table_style table_list1 " style="border-left: 1px solid #ccc; border-right: 1px solid #ccc!important;">
                                    ...
                                    <tr align="center">
                                        <td width="5%">序号</td>
                                        <td width="8%">运单号</td>
                                        <td width="10%"><a href="/SINOFAITH/wuliujjxx/seach?pageNo=1&orderby=ship_time">寄件时间</a></td>
                                        <td width="6%">寄件人</td>
                                        <td width="6%">寄件电话</td>
                                        <td width="15%">寄件地址</td>
                                        <td width="6%">收件人</td>
                                    ...
                                    <c:forEach items="${detailinfo}"
                                        ...
                                        <tr class="${st.index%2==1 ? '':'odd' }">
                                            ...
                                            <td align="center" title="${item.tjw}"><div style="width:160px;white-space: nowrap;text-overflow:ellipsis; overflow:hidden;">${item.tjw}</div></td>
                    ...
                    <div class="sidebar_right pos_re">
                       ...
                       <span class="fl_l width100 " style="padding-bottom: 10px;margin-top: 10px;">
                           ...
                           <button  type="button"  class="sideBar_r_button"  onclick="location.href='/SINOFAITH/wuliujjxx/download'" >数据导出</button>
                       </span>
                                    </div>
                                </div>
                            </div>

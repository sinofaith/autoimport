                            ...
                            <c:choose>
                                <c:when test="${detailinfo!=null && detailinfo.size()!=0}">
                                    <div  class="page_nmber">
                                        ...
                                        <input type="button" value="跳转" onclick="zzxxSkip()">
                                    </div>
                            ...
                            <div>
                                <form action="/SINOFAITH/cftzzxx/SeachCode" method="post">
                                    <div class="form-group_search  fl_l width100" >
                                        ...
                                        <textarea  class="form-control02 seachCode fl_l width100" id="seachCode" placeholder="请输入要查询内容,如果使用模糊查询请加%" name="seachCode" >${zzseachCode}</textarea>
                                    </div>
